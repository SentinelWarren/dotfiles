...
set scs                 " but become case sensitive if you type uppercase characters
set si                  " smart auto indenting
"set smarttab            " smart tab handling for indenting
set ts=2                " number of spaces a tab counts for
set sw=2                " spaces for autoindents
set et                  " turn a tab into spaces
set hls is              " highlight search results
set nu                  " print the line number
set ru                  " show line and column number
